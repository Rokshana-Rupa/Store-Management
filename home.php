  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <h1 class="fw-lighter fst-italic font-monospace text-warning">
          Store-EMS
        </h1>
        <button
    ...
    <header class="masthead">
      <div class="container">
        <div class="masthead-subheading">
          Welcome To Our
          <span class="fw-lighter fst-italic font-monospace text-warning"
            >Store-EMS</span
          >
        </div>
      ...
      <div class="container">
        ...
        <div class="row text-center">
          ...
          <div class="col-md-4">
            ...
            <h4 class="my-3">Secure Inventroy</h4>
            <p class="text-muted">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima
              maxime quam architecto quo inventore harum ex magni, dicta
              impedit.
